...
public class JTableRenderer extends JComponent {
	...
	public static final String IMAGE_PATH = "/com/gkd/jgraphx_example/images/";
	...
	public JTableRenderer(final Object cell, final mxGraphComponent graphContainer) {
		...
		JButton button = new JButton(new AbstractAction("", new ImageIcon(JTableRenderer.class.getResource(IMAGE_PATH + "minimize.gif"))) {
			public void actionPerformed(ActionEvent e) {
				System.out.println("manually fold");
				graph.foldCells(!graph.isCellCollapsed(cell), false, new Object[] { cell });
				((JButton) e.getSource()).setIcon(new ImageIcon(JTableRenderer.class.getResource(IMAGE_PATH + ((graph.isCellCollapsed(cell)) ? "maximize.gif" : "minimize.gif"))));
			}
		});
	...
	public class MyTable extends JTable implements DropTargetListener {
		...
		public void dragOver(DropTargetDragEvent e) {
			if (!((mxGraphTransferHandler) graphContainer.getTransferHandler()).isLocalDrag() && JTableRenderer.this != dragSource) {
