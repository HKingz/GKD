...
import com.gkd.jgraphx_example.editor.EditorActions.FontStyleAction;
...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		add(editor.bind("New", new NewAction(),
				"/com/gkd/jgraphx_example/images/new.gif"));
		add(editor.bind("Open", new OpenAction(),
				"/com/gkd/jgraphx_example/images/open.gif"));
		...
		add(editor.bind("Print", new PrintAction(),
				"/com/gkd/jgraphx_example/images/print.gif"));
