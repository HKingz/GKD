...
import com.gkd.jgraphx_example.editor.EditorActions.ExitAction;
...
import com.gkd.jgraphx_example.editor.EditorActions.NewAction;
import com.gkd.jgraphx_example.editor.EditorActions.OpenAction;
...
import com.gkd.jgraphx_example.editor.EditorActions.PrintAction;
import com.gkd.jgraphx_example.editor.EditorActions.PromptPropertyAction;
import com.gkd.jgraphx_example.editor.EditorActions.SaveAction;
...
public class SchemaEditorMenuBar extends JMenuBar {
	...
	public SchemaEditorMenuBar(final BasicGraphEditor editor) {
		...
		menu.add(editor.bind(mxResources.get("new"), new NewAction(), "/com/gkd/jgraphx_example/images/new.gif"));
		menu.add(editor.bind(mxResources.get("openFile"), new OpenAction(), "/com/gkd/jgraphx_example/images/open.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("save"), new SaveAction(false), "/com/gkd/jgraphx_example/images/save.gif"));
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true), "/com/gkd/jgraphx_example/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"), new PageSetupAction(), "/com/gkd/jgraphx_example/images/pagesetup.gif"));
		menu.add(editor.bind(mxResources.get("print"), new PrintAction(), "/com/gkd/jgraphx_example/images/print.gif"));
