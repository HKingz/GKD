...
import com.gkd.jgraphx_example.editor.EditorActions.AlignCellsAction;
import com.gkd.jgraphx_example.editor.EditorActions.AutosizeAction;
import com.gkd.jgraphx_example.editor.EditorActions.BackgroundAction;
import com.gkd.jgraphx_example.editor.EditorActions.BackgroundImageAction;
import com.gkd.jgraphx_example.editor.EditorActions.ColorAction;
import com.gkd.jgraphx_example.editor.EditorActions.GridColorAction;
import com.gkd.jgraphx_example.editor.EditorActions.GridStyleAction;
import com.gkd.jgraphx_example.editor.EditorActions.HistoryAction;
import com.gkd.jgraphx_example.editor.EditorActions.KeyValueAction;
import com.gkd.jgraphx_example.editor.EditorActions.PageBackgroundAction;
import com.gkd.jgraphx_example.editor.EditorActions.PageSetupAction;
import com.gkd.jgraphx_example.editor.EditorActions.PromptPropertyAction;
import com.gkd.jgraphx_example.editor.EditorActions.PromptValueAction;
import com.gkd.jgraphx_example.editor.EditorActions.ScaleAction;
import com.gkd.jgraphx_example.editor.EditorActions.SelectShortestPathAction;
import com.gkd.jgraphx_example.editor.EditorActions.SelectSpanningTreeAction;
import com.gkd.jgraphx_example.editor.EditorActions.SetLabelPositionAction;
import com.gkd.jgraphx_example.editor.EditorActions.SetStyleAction;
import com.gkd.jgraphx_example.editor.EditorActions.StyleAction;
import com.gkd.jgraphx_example.editor.EditorActions.StylesheetAction;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleAction;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleConnectModeAction;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleCreateTargetItem;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleDirtyAction;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleGridItem;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleOutlineItem;
import com.gkd.jgraphx_example.editor.EditorActions.TogglePropertyItem;
import com.gkd.jgraphx_example.editor.EditorActions.ToggleRulersItem;
import com.gkd.jgraphx_example.editor.EditorActions.WarningAction;
import com.gkd.jgraphx_example.editor.EditorActions.ZoomPolicyAction;
...
public class EditorMenuBar extends JMenuBar {
	...
	public EditorMenuBar(final BasicGraphEditor editor) {
		...
		menu.add(editor.bind(mxResources.get("new"), new EditorActions.NewAction(), "/com/gkd/jgraphx_example/images/new.gif"));
		menu.add(editor.bind(mxResources.get("openFile"), new EditorActions.OpenAction(), "/com/gkd/jgraphx_example/images/open.gif"));
		menu.add(editor.bind(mxResources.get("importStencil"), new EditorActions.ImportAction(), "/com/gkd/jgraphx_example/images/open.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("save"), new EditorActions.SaveAction(false), "/com/gkd/jgraphx_example/images/save.gif"));
		menu.add(editor.bind(mxResources.get("saveAs"), new EditorActions.SaveAction(true), "/com/gkd/jgraphx_example/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"), new PageSetupAction(), "/com/gkd/jgraphx_example/images/pagesetup.gif"));
		menu.add(editor.bind(mxResources.get("print"), new EditorActions.PrintAction(), "/com/gkd/jgraphx_example/images/print.gif"));
		...
		menu.add(editor.bind(mxResources.get("undo"), new HistoryAction(true), "/com/gkd/jgraphx_example/images/undo.gif"));
		menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false), "/com/gkd/jgraphx_example/images/redo.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(), "/com/gkd/jgraphx_example/images/cut.gif"));
		menu.add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(), "/com/gkd/jgraphx_example/images/copy.gif"));
		menu.add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/com/gkd/jgraphx_example/images/paste.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(), "/com/gkd/jgraphx_example/images/delete.gif"));
		...
		submenu.add(editor.bind(mxResources.get("basicStyle"), new StylesheetAction("/com/gkd/jgraphx_example/resources/basic-style.xml")));
		submenu.add(editor.bind(mxResources.get("defaultStyle"), new StylesheetAction("/com/gkd/jgraphx_example/resources/default-style.xml")));
	...
	public static void populateShapeMenu(JMenu menu, BasicGraphEditor editor) {
		menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/com/gkd/jgraphx_example/images/house.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/com/gkd/jgraphx_example/images/up.gif"));
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(), "/com/gkd/jgraphx_example/images/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/com/gkd/jgraphx_example/images/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(), "/com/gkd/jgraphx_example/images/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(), "/com/gkd/jgraphx_example/images/collapse.gif"));
		menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/com/gkd/jgraphx_example/images/expand.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/com/gkd/jgraphx_example/images/toback.gif"));
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(), "/com/gkd/jgraphx_example/images/tofront.gif"));

		menu.addSeparator();

		JMenu submenu = (JMenu) menu.add(new JMenu(mxResources.get("align")));

		submenu.add(editor.bind(mxResources.get("left"), new AlignCellsAction(mxConstants.ALIGN_LEFT), "/com/gkd/jgraphx_example/images/alignleft.gif"));
		submenu.add(editor.bind(mxResources.get("center"), new AlignCellsAction(mxConstants.ALIGN_CENTER), "/com/gkd/jgraphx_example/images/aligncenter.gif"));
		submenu.add(editor.bind(mxResources.get("right"), new AlignCellsAction(mxConstants.ALIGN_RIGHT), "/com/gkd/jgraphx_example/images/alignright.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("top"), new AlignCellsAction(mxConstants.ALIGN_TOP), "/com/gkd/jgraphx_example/images/aligntop.gif"));
		submenu.add(editor.bind(mxResources.get("middle"), new AlignCellsAction(mxConstants.ALIGN_MIDDLE), "/com/gkd/jgraphx_example/images/alignmiddle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new AlignCellsAction(mxConstants.ALIGN_BOTTOM), "/com/gkd/jgraphx_example/images/alignbottom.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor) {
		...
		submenu.add(editor.bind(mxResources.get("fillcolor"), new ColorAction("Fillcolor", mxConstants.STYLE_FILLCOLOR), "/com/gkd/jgraphx_example/images/fillcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("fontcolor"), new ColorAction("Fontcolor", mxConstants.STYLE_FONTCOLOR), "/com/gkd/jgraphx_example/images/fontcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("linecolor"), new ColorAction("Linecolor", mxConstants.STYLE_STROKECOLOR), "/com/gkd/jgraphx_example/images/linecolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("straight"), new SetStyleAction("straight"), "/com/gkd/jgraphx_example/images/straight.gif"));

		submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/com/gkd/jgraphx_example/images/connect.gif"));
		submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"), "/com/gkd/jgraphx_example/images/vertical.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"), "/com/gkd/jgraphx_example/images/entity.gif"));
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/com/gkd/jgraphx_example/images/arrow.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_OPEN),
				"/com/gkd/jgraphx_example/images/open_start.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_ENDARROW, mxConstants.ARROW_OPEN), "/com/gkd/jgraphx_example/images/open_end.gif"));
		submenu.add(editor.bind(mxResources.get("classic"), new KeyValueAction(mxConstants.STYLE_ENDARROW, mxConstants.ARROW_CLASSIC),
				"/com/gkd/jgraphx_example/images/classic_end.gif"));
		submenu.add(editor.bind(mxResources.get("block"), new KeyValueAction(mxConstants.STYLE_ENDARROW, mxConstants.ARROW_BLOCK),
				"/com/gkd/jgraphx_example/images/block_end.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("diamond"), new KeyValueAction(mxConstants.STYLE_ENDARROW, mxConstants.ARROW_DIAMOND),
				"/com/gkd/jgraphx_example/images/diamond_end.gif"));
		submenu.add(editor.bind(mxResources.get("oval"), new KeyValueAction(mxConstants.STYLE_ENDARROW, mxConstants.ARROW_OVAL), "/com/gkd/jgraphx_example/images/oval_end.gif"));
		...
		submenu.add(editor.bind(mxResources.get("left"), new KeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_LEFT), "/com/gkd/jgraphx_example/images/left.gif"));
		submenu.add(editor.bind(mxResources.get("center"), new KeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_CENTER), "/com/gkd/jgraphx_example/images/center.gif"));
		submenu.add(editor.bind(mxResources.get("right"), new KeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_RIGHT), "/com/gkd/jgraphx_example/images/right.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("top"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_TOP), "/com/gkd/jgraphx_example/images/top.gif"));
		submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
				"/com/gkd/jgraphx_example/images/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM),
				"/com/gkd/jgraphx_example/images/bottom.gif"));
